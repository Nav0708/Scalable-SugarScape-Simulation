...
Utilized HTCondor and Makeflow to scale up large amount of simulations with better running efficiency.
...
make data
    Run a number of random seeds comparing selected decision models on condor using Makeflow.
...
make condor
    Run the simulation on HTCondor using Makeflow.
